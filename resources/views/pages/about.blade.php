...
@section('content')
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <div class="jumbotron">
            <h1>About Sean</h1>
            <p>Currently I work as an SEO in Asbury Park, NJ. My responsibilites include managing search engine optimization, digital reputations, and front end design. This site is a work in progress.</p>
          </div> <!-- end of jumbrotron -->
        </div> <!-- end of columns -->
      </div> <!-- end of row -->
      <section class="row">
      	<header class="col-md-8 col-md-offset-2"><h2>Some notes about me and this site:</h2></header>
      	...
      	<footer class="col-md-2">Updated December 2017</footer>
      </section>
@endsection